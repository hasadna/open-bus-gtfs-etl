...
if not OPEN_BUS_STRIDE_PUBLIC_S3_OBJECT_PREFIX:
    OPEN_BUS_STRIDE_PUBLIC_S3_OBJECT_PREFIX = 'tests'
elif OPEN_BUS_STRIDE_PUBLIC_S3_OBJECT_PREFIX == '__production__':
    OPEN_BUS_STRIDE_PUBLIC_S3_OBJECT_PREFIX = None
